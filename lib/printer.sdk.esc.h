...
PRINTER_API int CALL_STACK DefineNVImageCompatibleW(void* hPrinter, const wchar_t** fileNameListW, int imageQty);
...
PRINTER_API int	CALL_STACK PrintImageW(void* hPrinter, const wchar_t* imagePathW, int scaleMode);
